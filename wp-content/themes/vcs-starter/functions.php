...
function theme_scripts(){
    ...
    //if ( !is_admin() ) {
        //wp_register_script('js_ajax', '//ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js', false, '3.1.1', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		wp_register_style('bootstrap', '//netdna.bootstrapcdn.com/bootstrap/3.0.3/css/bootstrap.min.css', array(), false, 'all');
		wp_register_style('font-awesome', '//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css', array(), false, 'all');
		wp_register_style('fonts', '//fonts.googleapis.com/css?family=Open+Sans:300,400,600,700', array(), false, 'all');

		wp_register_style('ajax', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', array(), false, 'all');


		wp_register_style('main-css', ASSETS_URL . '/assets/css/style.css', array('bootstrap', 'font-awesome', 'fonts', 'ajax'), false, 'all');
